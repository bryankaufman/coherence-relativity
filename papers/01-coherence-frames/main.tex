...
\end{equation}
This is the Freidlin--Wentzell large-deviation functional~\cite{FreidlinWentzell2012}, which defines the minimum-cost path for fluctuation-driven excursions through state space. The novel application here is the use of coherence space $\Sigma$ as the arena and the Fubini--Study metric $G_{AB}$ as the cost tensor---a construction with no prior precedent in the quantum decoherence literature.
